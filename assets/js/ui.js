...
(function () {
  ...
  var KB = [
    ...
    { k: ['certification','certified','pmp','csm','scrum','agile','lcap','credential','qualification','education','degree'],
      a: "<b>PMP® · Scrum Master · LTIMindtree Certified Agile Practitioner.</b> Plus AI4ICPS (IIT Kharagpur), Agentic AI (Johns Hopkins, in progress), PMI GenAI for PMs, IBM Enterprise Design Thinking. Education: M.Sc. IT (Sikkim Manipal) and BCA." },
